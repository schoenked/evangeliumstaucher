...
public final class XMLUtil {
    ...
    private static final Set<String> goodEntities = new HashSet<String>();
    private static final PropertyMap badEntities = new PropertyMap();
    /**
     * Pattern for numeric entities.
     */
    private static final Pattern validCharacterEntityPattern = Pattern.compile("^&#x?\\d{2,4};");
    /**
     ...
     */
    private static final Pattern openHTMLTagPattern = Pattern.compile("<(img|hr|br)([^>]*)(?<!/)>");
