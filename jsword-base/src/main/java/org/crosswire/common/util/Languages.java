...
public final class Languages {
    ...
    private static final Map<Locale, ResourceBundle> localisedCommonLanguages = new HashMap<Locale, ResourceBundle>();
    ...
    public static final class RtoL {
         ...
         * Note: It is OK for it not to be present.
         */
        private static final Set rtol = new HashSet();
