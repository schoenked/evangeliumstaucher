...
public final class JobManager {
     ...
     */
    private static final List<WorkListener> listeners = new CopyOnWriteArrayList<WorkListener>();
    /**
     * List of current jobs
     */
    private static final Set<Progress> jobs = new CopyOnWriteArraySet<Progress>();
     ...
     */
    static void fireWorkProgressed(Progress job) {
