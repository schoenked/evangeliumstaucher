...
public class ConfigurableSnowballAnalyzer extends AbstractBookAnalyzer {
    private static final Map<String, String> languageCodeToStemmerLanguageNameMap = new HashMap<String, String>();
    // Maps StemmerName > String array of standard stop words
    private static final HashMap<String, Set<?>> defaultStopWordMap = new HashMap<String, Set<?>>();
