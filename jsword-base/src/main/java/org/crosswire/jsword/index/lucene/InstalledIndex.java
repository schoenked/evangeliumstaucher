...
public final class InstalledIndex {
    ...
    private static final String metadataFileComment = "Search index properties that stay persistent on clients computer. Used during index upgrades."
    ...
    private static final InstalledIndex myInstance = new InstalledIndex();
    ...
    private InstalledIndex() {
        ...
        try {
            ...
            log.error("Property file read error: " + propURI, e);
        }
    }
    ...
    private void storeInstalledIndexMetadata() throws IOException {
        synchronized (writeLock) {
            NetUtil.storeProperties(props, getPropertyFileURI(), metadataFileComment);
        }
    }
