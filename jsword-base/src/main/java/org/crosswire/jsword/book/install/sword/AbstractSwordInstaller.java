    ...
    protected void unpack(URI cacheDir, URI cache) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                if (n != size) {
                    log.error("Error: Could not read {} bytes for {} from {}", size, path, cache.getPath());
                }
    ...
    protected void loadCachedIndex() throws IOException, InstallException, BookException {
        ...
        try {
            ...
            while (true) {
                ...
                if (offset != size) {
                    log.error("Error: Could not read {} bytes, instead {}, for {} from {}", size, offset, path, cache.getPath());
                }
