...
public final class Books extends AbstractBookList {
     ...
     */
    private final Map<String, Book> initials;
    /**
     * The map of book names
     */
    private final Map<String, Book> names;
    /**
     * An array of BookDrivers
     */
    private final Set<BookDriver> drivers;
    ...
    private void autoRegister() {
        ...
        log.debug("begin auto-registering {} drivers:", types.length);
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            try {
                Method driverInstance = types[i].getMethod("instance");
