...
public final class OSISUtil {
    ...
    private static final Set<String> EXTRA_BIBLICAL_ELEMENTS = new HashSet<String>(Arrays.asList(OSIS_ELEMENT_NOTE, OSIS_ELEMENT_TITLE, OSIS_ELEMENT_REFERENCE));

    /**
     * The log stream
     */
    private static final Logger log = LoggerFactory.getLogger(OSISUtil.class);
    private static final OSISFactory factory = new OSISFactory();
    private static final String strongsNumber = "strong:([GgHh][0-9]+!?[A-Za-z]*)";
    private static final Pattern strongsNumberPattern = Pattern.compile(strongsNumber);
