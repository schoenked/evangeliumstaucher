...
public final class Defaults {
     ...
     * The default Bible
     */
    private static final DefaultBook bibleDeft = new DefaultBook(Books.installed(), BookFilters.getOnlyBibles());
    /**
     * The default Commentary
     */
    private static final DefaultBook commentaryDeft = new DefaultBook(Books.installed(), BookFilters.getCommentaries());
    /**
     * The default DailyDevotional
     */
    private static final DefaultBook dailyDevotionalDeft = new DefaultBook(Books.installed(), BookFilters.getDailyDevotionals());
    /**
     * The default Dictionary
     */
    private static final DefaultBook dictionaryDeft = new DefaultBook(Books.installed(), BookFilters.getDictionaries());
    /**
     * The default Greek Parse Dictionary.
     */
    private static final DefaultBook greekParseDeft = new DefaultBook(Books.installed(), BookFilters.getGreekParse());
    /**
     * The default Hebrew Parse Dictionary.
     */
    private static final DefaultBook hebrewParseDeft = new DefaultBook(Books.installed(), BookFilters.getHebrewParse());
    /**
     * The default Greek Definitions Dictionary.
     */
    private static final DefaultBook greekDefinitionsDeft = new DefaultBook(Books.installed(), BookFilters.getGreekDefinitions());
    /**
     * The default Hebrew Definitions Dictionary.
     */
    private static final DefaultBook hebrewDefinitionsDeft = new DefaultBook(Books.installed(), BookFilters.getHebrewDefinitions());
     ...
     */
    private static void unsetBible() {
     ...
     */
    private static void unsetCommentary() {
     ...
     */
    private static void unsetDictionary() {
     ...
     */
    private static void unsetDailyDevotional() {
     ...
     */
    private static void unsetGreekDefinitions() {
     ...
     */
    private static void unsetHebrewDefinitions() {
     ...
     */
    private static void unsetGreekParse() {
     ...
     */
    private static void unsetHebrewParse() {
     ...
     * @return the default Bible
     */
    private static DefaultBook getDefaultBible() {
        return bibleDeft;
    }
     ...
     * @return the default commentary
     */
    private static DefaultBook getDefaultCommentary() {
     ...
     * @return the default dictionary
     */
    private static DefaultBook getDefaultDictionary() {
     ...
     * @return the default daily devotional
     */
    private static DefaultBook getDefaultDailyDevotional() {
     ...
     * @return the default Greek Strong's Numbers dictionary
     */
    private static DefaultBook getDefaultGreekDefinitions() {
     ...
     * @return the default Hebrew Strong's Numbers dictionary
     */
    private static DefaultBook getDefaultHebrewDefinitions() {
     ...
     * @return the default Greek morphology dictionary
     */
    private static DefaultBook getDefaultGreekParse() {
     ...
     * @return the default Hebrew morphology dictionary
     */
    private static DefaultBook getDefaultHebrewParse() {
