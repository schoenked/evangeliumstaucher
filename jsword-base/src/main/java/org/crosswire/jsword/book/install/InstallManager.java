...
public final class InstallManager {
     ...
     */
    private final List<InstallerListener> listeners;
    ...
    public String getFactoryNameForInstaller(Installer installer) {
        ...
        log.warn("Failed to find factory name for {} among the {} factories.", installer, factories.size());
        return null;
    }
    ...
    public String getInstallerNameForInstaller(Installer installer) {
        ...
        log.warn("Failed to find installer name for {} among the {} installers.", installer, installers.size());
        for (String name : installers.keySet()) {
            Installer test = installers.get(name);
     ...
     *            Is it added?
     */
    private void fireInstallersChanged(Object source, Installer installer, boolean added) {
