...
public class PassageTally extends AbstractPassage {
    ...
    private static final class OrderedVerseIterator implements Iterator<Key> {
         ...
         */
        private final Versification referenceSystem;
        /**
         ...
         */
        private final Iterator<TalliedVerse> it;

        /**
         * Find the first unused verse
         */
        private OrderedVerseIterator(Versification v11n, int[] board) {
    ...
    private static final class OrderedVerseRangeIterator implements Iterator<VerseRange> {
         ...
         * The Iterator we are converting
         */
        private final Iterator<TalliedVerseRange> it;
         ...
         * @param board
         */
        private OrderedVerseRangeIterator(Versification v11n, Iterator<Key> vit, int[] board) {
