...
public class RangedPassage extends AbstractPassage {
    ...
    private static final class VerseIterator implements Iterator<Key> {
         ...
         */
        private final Iterator<Key> real;
         ...
         * @param it
         */
        private VerseIterator(Versification v11n, Iterator<VerseRange> it) {
    ...
    private static final class VerseRangeIterator implements Iterator<VerseRange> {
         ...
         */
        private final RestrictionType restrict;
        /**
         * Where we read our base ranges from
         */
        private final Iterator<VerseRange> real;
         ...
         * @param restrict
         */
        private VerseRangeIterator(Iterator<VerseRange> it, RestrictionType restrict) {
