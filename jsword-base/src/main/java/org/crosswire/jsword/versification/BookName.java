...
public final class BookName {
    ...
    private static final Pattern normPattern = Pattern.compile("[. ]");
    ...
    private final String normalizedLongName;
    private final String shortName;
    private final String normalizedShortName;
    ...
    public boolean match(String normalizedName) {
        ...
        // or a short version
        return normalizedShortName.startsWith(normalizedName) || (normalizedShortName.length() > 0 && normalizedName.startsWith(normalizedShortName));
    }
