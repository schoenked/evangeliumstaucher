...
public class VersificationToKJVMapper {
    ...
    private final Versification nonKjv;
    /* the absent verses, i.e. those present in the KJV, but not in the left versification */
    private final Passage absentVerses;
    private final Map<VerseKey, List<QualifiedKey>> toKJVMappings;
    private final Map<QualifiedKey, Passage> fromKJVMappings;
    ...
    private void reportCardinalityError(final VerseKey leftKeys, final VerseKey kjvKeys) {
        ...
        throw new LucidRuntimeException(String.format("%s has a cardinality of %s whilst %s has a cardinality of %s.",
                leftKeys, leftKeys.getCardinality(),
                kjvKeys, kjvKeys.getCardinality()));
    }
    ...
    public void dump(PrintStream out) {
        ...
        out.println("##############################");
        out.printf("Mapping between KJV and %s", nonKjvName);
        out.println("##############################");
        out.println("    ******************************");
