...
public enum BibleBook {
    ...
    private static final Map<String, BibleBook> osisMap = new HashMap<String, BibleBook>(128);
    private static final Map<String, BibleBook> exactMatches = new HashMap<String, BibleBook>(128);
