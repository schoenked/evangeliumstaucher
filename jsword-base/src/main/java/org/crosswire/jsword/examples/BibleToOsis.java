...
public class BibleToOsis {
    ...
    private static final String preVerseStart = "<title subtype=\"x-preverse\" type=\"section\">";
    private static final String preVerseElement = "<title subtype=\"x-preverse\" type=\"section\">(.*?)</title>";
    private static final Pattern preVersePattern = Pattern.compile(preVerseElement);
    private static final String psalmTitleStart = "<title type=\"psalm\">";
    private static final String psalmTitleElement = "<title type=\"psalm\">(.*?)</title>";
    private static final Pattern psalmTitlePattern = Pattern.compile(psalmTitleElement);
    ...
    private void openOutputFile(String newFilename, boolean open) throws IOException {
        if (open) {
            ...
            writer = new OutputStreamWriter(new FileOutputStream(filename + ".xml"), StandardCharsets.UTF_8);
        }
    }
