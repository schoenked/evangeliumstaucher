...
public final class GatherAllReferences {
    ...
    private static final Pattern thmlPassagePattern = Pattern.compile("(osisRef|passage)=\"([^\"]*)");
    private static final Pattern gbfPassagePattern = Pattern.compile("(<RX>)([^<]*)");
    private static final Pattern osisPassagePattern = Pattern.compile("(osisRef)=\"([^\"]*)");
