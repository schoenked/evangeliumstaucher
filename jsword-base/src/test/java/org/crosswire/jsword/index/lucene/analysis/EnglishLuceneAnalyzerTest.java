...
public class EnglishLuceneAnalyzerTest {
    ...
    public void testSetDoStopWords() throws ParseException {
        ...
        // enable stop word
        Assert.assertEquals(-1, query.toString().indexOf(FIELD + ":will"));
    }
    ...
    public void testCustomStopWords() throws Exception {
        ...
        Assert.assertEquals(-1, query.toString().indexOf(FIELD + ":shalt"));
        Assert.assertEquals(-1, query.toString().indexOf(FIELD + ":thy"));
