...
public class VerseTest {
    ...
    public void testEquals() {
        Assert.assertFalse(gen11.equals(null));
        Assert.assertFalse(gen11.equals(Integer.valueOf(0)));
        Assert.assertFalse(gen11.equals("org.crosswire.jsword.passage.Verse"));
        Assert.assertEquals(gen11, gen11a);
        Assert.assertFalse(gen11.equals(gen12));
        Assert.assertFalse(gen11.equals(rev99));
        Assert.assertFalse(gen11.equals(gen12));
    }
    ...
    public void testGetAccuracy() throws Exception {
        ...
        try {
            AccuracyType.fromText(v11n, null, null, vr);
            Assert.fail();
        } catch (NullPointerException ex) {
            // This is allowed
        }
    ...
    public void testIsStartEndOfChapterBook() throws Exception {
        ...
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen 1:10")));
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen 1:$")));
        Assert.assertTrue(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen 10:0")));
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen 10:10")));
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen 10:$")));
        Assert.assertTrue(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen $:0")));
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen $:10")));
        Assert.assertFalse(v11n.isStartOfChapter(VerseFactory.fromString(v11n, "Gen $:$")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 1:1")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 1:10")));
        Assert.assertTrue(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 1:$")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 10:1")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 10:10")));
        Assert.assertTrue(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen 10:$")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen $:1")));
        Assert.assertFalse(v11n.isEndOfChapter(VerseFactory.fromString(v11n, "Gen $:10")));
        ...
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen 1:10")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen 1:$")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen 10:1")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen 10:10")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen 10:$")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen $:1")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen $:10")));
        Assert.assertFalse(v11n.isStartOfBook(VerseFactory.fromString(v11n, "Gen $:$")));

        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 1:1")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 1:10")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 1:$")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 10:1")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 10:10")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen 10:$")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen $:1")));
        Assert.assertFalse(v11n.isEndOfBook(VerseFactory.fromString(v11n, "Gen $:10")));
