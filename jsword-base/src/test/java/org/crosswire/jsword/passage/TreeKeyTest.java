...
public class TreeKeyTest {
    ...
    public void testEquals() throws Exception {
        Assert.assertEquals(pilgrimPart1FirstStage, pilgrimPart1FirstStageClone);
        Assert.assertNotEquals(pilgrimPart1FirstStage, pilgrimPart2FirstStage);
        Assert.assertNotEquals(null, pilgrimPart1FirstStage);
        Assert.assertNotEquals(pilgrimPart1FirstStage, pilgrimPart1);
        Assert.assertEquals(pilgrimPart1FirstStage.getParent(), pilgrimPart1);
    }
