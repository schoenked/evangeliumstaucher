...
public class VerseRangeTest {
    ...
    public void testNewViaString() throws Exception {
        ...
        try {
            VerseRangeFactory.fromString(v11n, null);
            Assert.fail();
        } catch (NoSuchVerseException expected) {
            // This is allowed
        }
    ...
    public void testNewViaVerseRangeVerseRange() {
        ...
        try {
            new VerseRange(null, rangeGenC1V1toRevEnd);
            Assert.fail();
        } catch (NullPointerException expected) {
            // This is allowed
        }
        try {
            new VerseRange(null, (VerseRange) null);
            Assert.fail();
        } catch (NullPointerException expected) {
            // This is allowed
        }
    ...
    public void testClone() {
        Assert.assertNotSame(rangeGenC1V1, rangeGenC1V1.clone());
        Assert.assertEquals(rangeGenC1V1, rangeGenC1V1.clone());
        Assert.assertNotSame(rangeRevC22V21, rangeRevC22V21.clone());
        Assert.assertEquals(rangeRevC22V21, rangeRevC22V21.clone());
    }
    ...
    public void testCompareTo() {
        ...
        Assert.assertEquals(0, rangeGenC1V1.compareTo(rangeGenC1V1));
        ...
        Assert.assertEquals(0, rangeGenC1V2.compareTo(rangeGenC1V2));
    ...
    public void testAdjacentTo() throws Exception {
        Assert.assertFalse(rangeGenC1V1.adjacentTo(rangeRevC22V0toEnd));
        Assert.assertFalse(rangeGenC1V1.adjacentTo(rangeRevC0V0toEnd));
        Assert.assertFalse(rangeGenC1V2.adjacentTo(rangeRevC22V0toEnd));
        Assert.assertFalse(rangeRevC22V21.adjacentTo(rangeGenC1V1));
        ...
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Gen 1:10-11").adjacentTo(VerseRangeFactory.fromString(v11n, "Gen 1:13-14")));
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Gen 1:13-14").adjacentTo(VerseRangeFactory.fromString(v11n, "Gen 1:10-11")));
        try {
    ...
    public void testOverlaps() throws Exception {
        ...
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Gen 1:10-11").overlaps(VerseRangeFactory.fromString(v11n, "Gen 1:12-13")));
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Gen 1:12-13").overlaps(VerseRangeFactory.fromString(v11n, "Gen 1:10-11")));
        try {
    ...
    public void testContainsVerse() {
        ...
        Assert.assertFalse(rangeRevC22V0toEnd.contains(genC1V1));
        Assert.assertFalse(rangeGenC1V1.contains(genC1V2));
        Assert.assertFalse(rangeGenC0V0toEnd.contains(exoC1V1));
        Assert.assertFalse(rangeRevC22V0toEnd.contains(revC1V1));
        try {
    ...
    public void testContainsVerseRange() {
        ...
        Assert.assertFalse(rangeGenC1V12.contains(rangeGenC0V0toEnd));
        Assert.assertFalse(rangeGenC1V2.contains(rangeGenC1V12));
        Assert.assertTrue(rangeRevC22V0toEnd.contains(rangeRevC22V0toEnd));
        Assert.assertFalse(rangeRevC22V0toEnd.contains(rangeGenC0V0toEnd));
        Assert.assertTrue(rangeRevC22V0toEnd.contains(rangeRevC22V21));
        Assert.assertFalse(rangeGenC1V1.contains(rangeRevC22V0toEnd));
        Assert.assertTrue(rangeGenC0V0toEnd.contains(rangeGenC1V2));
        Assert.assertFalse(rangeRevC22V0toEnd.contains(rangeRevC0V0toEnd));
        try {
    ...
    public void testIsChapter() throws Exception {
        ...
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 3:1").isWholeChapter());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 4:1-5:1").isWholeChapter());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 5:1-6:ff").isWholeChapter());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Lev").isWholeChapter());
    }
    ...
    public void testIsBook() throws Exception {
        ...
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 1:2-Num $:$").isWholeBook());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 4:1-5:1").isWholeBook());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Num 5:1-6:ff").isWholeBook());
        Assert.assertFalse(VerseRangeFactory.fromString(v11n, "Lev-Deu 1:1").isWholeBook());
    }
