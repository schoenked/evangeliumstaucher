...
public class PassageTally2Test {
    ...
    private final PassageTally tally = new PassageTally(Versifications.instance().getVersification("KJV"));
    private final PassageTally empty = new PassageTally(Versifications.instance().getVersification("KJV"));
    ...
    public void testClone() {
        Assert.assertNotSame(tally, tally.clone());
        Assert.assertEquals(tally, tally.clone());
        Assert.assertNotSame(empty, empty.clone());
    ...
    public void testIsEmpty() {
        Assert.assertFalse(tally.isEmpty());
    ...
    public void testContainsVerse() {
        ...
        Assert.assertFalse(tally.contains(genC1V2));
    ...
    public void testContainsVerseRange() {
        Assert.assertFalse(empty.contains(genC1V1r));
        Assert.assertTrue(tally.contains(genC1V1r));
        Assert.assertFalse(tally.contains(genC1V12r));
        Assert.assertFalse(tally.contains(genC1V2r));
        Assert.assertFalse(tally.contains(exoC2V1r));
    }
