...
public class OsisParserTest {
    private final Versification testV11n = Versifications.instance().getVersification(Versifications.DEFAULT_V11N);

    private final OsisParser osisParser = new OsisParser();
    ...
    public void testVerseParsingErrors() {
        Assert.assertNull(osisParser.parseOsisID(testV11n, "Gen.1.1.4"));
        Assert.assertNull(osisParser.parseOsisID(testV11n, "Gen."));
        Assert.assertNull(osisParser.parseOsisID(testV11n, "Gen21"));
        Assert.assertNull(osisParser.parseOsisID(testV11n, ""));
        Assert.assertNull(osisParser.parseOsisID(testV11n, null));
    }
    ...
    public void testVerseRangeParsingErrors() {
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen.1.1.4"));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen."));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen.1."));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen21"));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen.2.1-"));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "Gen1-Gen.3"));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, "-Gen.3"));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, ""));
        Assert.assertNull(osisParser.parseOsisRef(testV11n, null));
    }
