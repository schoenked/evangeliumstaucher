...
public class PassageParentTst {
     ...
     */
    private static final PassageKeyFactory keyf = PassageKeyFactory.instance();
    ...
    public void testReadIsEmpty() {
        Assert.assertFalse(genC1V135r.isEmpty());
        Assert.assertFalse(exoC2V1To10C2V1To11r.isEmpty());
    ...
    public void testReadContainsVerse() {
        Assert.assertFalse(empty.contains(genC1V1));
        Assert.assertTrue(genC1V135r.contains(genC1V1));
        Assert.assertFalse(genC1V135r.contains(genC1V2));
    ...
    public void testReadContainsVerseRange() {
        ...
        Assert.assertFalse(genC1V135r.contains(genC1V12r));
        Assert.assertFalse(genC1V135r.contains(genC1V2r));
        Assert.assertFalse(genC1V135r.contains(exoC2V1r));
        Assert.assertFalse(exoC2V1To10C2V1To11r.contains(genC1V1r));
    ...
    public void testReadContainsAll() {
        Assert.assertFalse(genC1V135r.containsAll(exoC2V1To10C2V1To11r));
        Assert.assertTrue(genC1V135r.containsAll(empty));
        Assert.assertTrue(genC1V135r.containsAll((Passage) genC1V135r.clone()));
        Assert.assertFalse(exoC2V1To10C2V1To11r.containsAll(genC1V135r));
    ...
    public void testWriteClone() {
        Assert.assertNotSame(genC1V135r, genC1V135r.clone());
        Assert.assertEquals(genC1V135r, genC1V135r.clone());
        Assert.assertNotSame(exoC2V1To10C2V1To11r, exoC2V1To10C2V1To11r.clone());
    ...
    public void testWriteContainsAll() {
        ...
        Assert.assertTrue(exoC2V1To10C2V1To11r.containsAll(empty));
        Assert.assertTrue(exoC2V1To10C2V1To11r.containsAll((Passage) exoC2V1To10C2V1To11r.clone()));
        Assert.assertFalse(empty.containsAll(genC1V135r));
        Assert.assertTrue(empty.containsAll(empty));
        Assert.assertFalse(empty.containsAll(exoC2V1To10C2V1To11r));
