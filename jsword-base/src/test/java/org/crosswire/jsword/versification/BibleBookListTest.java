...
public class BibleBookListTest {
    ...
    private static final BibleBook[] booksNT =
            {
                    BibleBook.MATT,
                    BibleBook.MARK,
                    BibleBook.LUKE,
    ...
    public void testNextBook() {
        ...
        Assert.assertNull("Next after last book", list.getNextBook(booksNT[booksNT.length - 1]));
        // Test a book not in the list
        Assert.assertNull(BibleBook.GEN.getOSIS(), list.getNextBook(BibleBook.GEN));
    }
    ...
    public void testPreviousBook() {
        ...
        Assert.assertNull("Prior before first book", list.getPreviousBook(booksNT[0]));
        // Test a book not in the list
        Assert.assertNull(BibleBook.GEN.getOSIS(), list.getPreviousBook(BibleBook.GEN));
    }
