...
public class LanguageTest {
    ...
    public void testCanonical() {
        ...
        Assert.assertNull("Test for LL.getScript", lang.getScript());
        Assert.assertNull("Test for LL.getCountry", lang.getCountry());
        ...
        Assert.assertNull("Test for LL-SSSS.getCountry", lang.getCountry());
        lang = new Language("en-US");
        Assert.assertEquals("Test for LL-CC.getCode", "en", lang.getCode());
        Assert.assertNull("Test for LL-CC.getScript", lang.getScript());
        ...
        Assert.assertNull("Test for LL-CC-SSSS.getScript", lang.getScript());
